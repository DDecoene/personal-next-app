                    ...
                    <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
                        <Stack spacing={4}>
                            ...
                            <Stack
                                ...
                                <Feature
                                    icon={<Icon as={FaEthereum} color={'gray.500'} w={5} h={5} />}
                        ...
                        <Flex>
                            <Image
                                ...
                                alt={'feature image'}
                                src={
                                    'https://images.unsplash.com/photo-1559030623-0226b1241edd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2831&q=80'
                                }
                                objectFit={'cover'}
                            />
                        </Flex>
